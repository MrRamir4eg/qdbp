...
public class ThirdActivity extends Activity implements OnClickListener{
    ...
    private Button chats_btn, contacts_btn, settings_btn;
    @Override
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.chats_btn:
                Intent chats_i = new Intent(ThirdActivity.this, MainActivity.class);
                startActivity(chats_i);
                break;
            case R.id.contacts_btn:
                Intent contacts_i = new Intent(ThirdActivity.this, ThirdActivity.class);
                startActivity(contacts_i);
                break;
            case R.id.settings_btn:
                Intent settings_i = new Intent(ThirdActivity.this, SecondActivity.class);
