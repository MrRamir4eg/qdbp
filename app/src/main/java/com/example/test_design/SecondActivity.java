...
public class SecondActivity extends Activity implements OnClickListener{
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.chats_btn:
                Intent chats_i = new Intent(SecondActivity.this, MainActivity.class);
                startActivity(chats_i);
                break;
            case R.id.contacts_btn:
                Intent contacts_i = new Intent(SecondActivity.this, ThirdActivity.class);
                startActivity(contacts_i);
                break;
            case R.id.settings_btn:
                Intent settings_i = new Intent(SecondActivity.this, SecondActivity.class);
